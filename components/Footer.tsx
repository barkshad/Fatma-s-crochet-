    ...
    <footer className="bg-brand-brown text-brand-cream mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a href={`mailto:${content?.contactEmail}`} className="hover:text-brand-roseDark transition-colors" aria-label="Email"><Mail size={24} /></a>
            </div>
          </div>
        ...
        <div className="border-t border-brand-cream/20 mt-12 pt-8 text-center font-sans text-sm text-brand-cream/60 flex flex-col items-center">
          ...
          <Link to="/admin" className="flex items-center gap-1 text-xs opacity-50 hover:opacity-100 transition-opacity p-2 border border-transparent hover:border-brand-cream/20 rounded">
            <Lock size={12} /> Edit Website
          </Link>
        </div>
      </div>
    </footer>
